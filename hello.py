...
def nextQuestionnaire2(check):
        print(check)
        if check:
            prompt2 = "I am enrolled in SNAP program. "
        else:
            prompt2 = "I am not enrolled in SNAP program. "
        print(prompt2)
        return {
...
def nextQuestionnaire1(ques1, ques2, ques3):
        prompt = "Location zip code: " + ques1 + ". Number of kids below age 5: " + ques2 + ". Number of kids aged 5 to 18: " + ques3
        print(prompt)
        return {
...
with gr.Blocks() as demo:
    ...
    with gr.Group(visible=False) as questionnairePage3:
        ...
        with gr.Tab(englishLabels['lang-2']):
            ...
            aiHelper.click(startbot, inputs=[ques1,ques2,ques3,ques4,ques5,ques6,ques7,ques8,ques9], outputs=[botScreen,questionnairePage3])
